# Financial-Transactions-Dataset-Analytic
...
* transactions throughout the 2010s
...
3. Card Information (cards_dat.csv)
...
4. Merchant Category Codes (mcc_codes.json)
